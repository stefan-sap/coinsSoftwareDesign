...
import coins.CADDime;

/**
* Junit Tests for CADDime.java.
*
* @author Communism
* @version 04/02/2022
*/
public class TestCADDime {
  ...
  */
  ...
  public void testToString() {
    String expectedOutput = "[CAD Dime $0.10][%93.03 Zinc, %6.97 Nickle]";
    redirectOutput();
