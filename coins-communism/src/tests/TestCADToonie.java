...
import coins.CADToonie;

/**
* Junit Tests for CADToonie.java.
*
* @author Communism
* @version 04/02/2022
*/
public class TestCADToonie {

  private PrintStream originalOut;
  private ByteArrayOutputStream baos;
  private PrintStream newOut;
  private CADToonie CADCoin;

  /**
  * Creates a Canadian Toonie for each test to use.
  * Does not redirect System.out as only one test uses that.
  */
  @BeforeEach
  public void beforeEach() {
    CADCoin = new CADToonie();
  }
  ...
  */
  ...
  public void testToString() {
    String expectedOutput = "[CAD Toonie $2.00][%94.03 Zinc, %5.97 Magnesium]";
    redirectOutput();
