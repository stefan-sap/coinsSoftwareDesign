...
import coins.HalfDollar;

/**
* Junit Tests for HalfDollar.java.
*
* @author Communism
* @version 04/02/2022
*/
public class TestHalfDollar {
  ...
  */
  ...
  public void testCommonName() {
    String expectedOutput = "Half Dollar";
  ...
  */
  ...
  public void testToString() {
    String expectedOutput = "[USD Half Dollar $0.50][%91.67 Copper, %8.33 Nickle]";
    redirectOutput();
